package com.unl.login.base.controller.data_struct.list;
...
public class LinkedList<E> {
    ...
    public E delete(Integer post) throws Exception {
        if (isEmpty()) {
            ...
            E element = actual.getData(); // Guardar el dato del nodo a eliminar
            ...
            length--; // Reducir el tamaño de la lista
