...
import Usuario from 'Frontend/generated/com/unl/proyectogrupal/base/models/Usuario';
...
export function UsuarioGrid({
  ...
  usuarios: Usuario[];
  onSeleccionar: (usuario: Usuario, accion: 'editar' | 'eliminar') => void;
}) {
  return (
    <div
      style={{
    ...
    >
      ...
      >
        ...
        />
          ...
          <GridColumn path="correo" header="Correo Electronico" />
